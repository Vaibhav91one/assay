...
import { openDecisions, type Decision } from '@/lib/queue';
import { fieldsView, type FieldRow } from '@/lib/fields';
import { runsView, type RunRow } from '@/lib/runs';
...
export async function readCommand(name: CommandName): Promise<CommandResult> {
